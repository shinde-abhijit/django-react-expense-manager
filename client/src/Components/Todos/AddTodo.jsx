...
const AddTodo = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await api.post('/todos/', { title, status, description });
      navigate('/todo-list'); // Redirect to todos list or homepage
    } catch (err) {
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
      <h2 className="text-2xl font-semibold mb-6 text-gray-800 uppercase text-center">Add Todo</h2>
