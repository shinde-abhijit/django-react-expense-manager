...
const DeleteContact = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-20 bg-white p-6 rounded shadow-md text-center">
      {!confirmed && (
        <>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Are you sure you want to delete this contact?</h2>
      ...
      {confirmed && !loading && (
        <>
          <p className="text-gray-700 mb-4">Deleting contact...</p>
          {handleConfirmDelete()}
        </>
      )}
