...
class CustomUserCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(attrs={'class': register_input_classes, 'placeholder': 'Enter First Name'}),
            'last_name': forms.TextInput(attrs={'class': register_input_classes, 'placeholder': 'Enter Last Name'}),
            'email': forms.TextInput(attrs={'class': register_input_classes, 'placeholder': 'Enter Email Address'}),
            'contact': forms.TextInput(attrs={'class': register_input_classes, 'placeholder': 'Enter Contact Number'}),
            'password': forms.TextInput(attrs={'class': register_input_classes, 'placeholder': 'Enter Password'}),
            'confirm_password': forms.TextInput(attrs={'class': register_input_classes, 'placeholder': 'Confirm Password'}),
            'profile_image': forms.ClearableFileInput(attrs={'class': file_upload_classes}),
        }
...
class CustomUserLoginForm(AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update({'class': register_input_classes, 'placeholder': 'Enter Email'})
        self.fields['password'].widget.attrs.update({'class': register_input_classes, 'placeholder': 'Enter Password'})
...
class CustomUserDeleteForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password'].widget.attrs.update({'class': register_input_classes, 'placeholder': 'Enter your password to confirm'})
